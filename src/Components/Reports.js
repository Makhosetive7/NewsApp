...
const Reports = () => {
  ...
  const handleFavoriteClick = (report) => {
    setFavorites([...favorites, report]);
    console.log(report);
    toast("Added report to favorites!", {
          ...
          reports.map((report, index) => (
            <div className="subContainer">
              ...
              <div className="news_source_title">
                <h2>{`${report.newsSite.substring(0, 30)}`}</h2>
              </div>
                <div className="Summary">{`${report.summary.substring(
                  0,
                  200
                )}...`}</div>
                  ...
                  <button
                    ...
                    onClick={() => handleFavoriteClick(report)}
                  >
                    <AiOutlineHeart />
                  </button>
                </div>
